        ...
        (function (f, r) {
            ...
            return (function (s) {
                ...
                function r(l) {
                    ...
                    return (
                        s[l].call(a.exports, a, a.exports, r),
                        (a.l = !0),
                        a.exports
                    );
                }
...
*/ (function () {
        ...
        (function (s, f) {
            ...
            const s = new Map(),
                ...
                ue = (n, e, t = !0) => {
                    ...
                    const d = ({ target: y }) => {
                        y === e &&
                            ((c = !0), e.removeEventListener(a, d), H(n));
                    };
            ...
            function Qe(n, e, t, i, o) {
                const c = Se(e[t], i, o);
                c &&
                    (n.removeEventListener(t, c, !!o), delete e[t][c.uidEvent]);
            }
            function Cr(n, e, t, i) {
                const o = e[t] || {};
                for (const [c, d] of Object.entries(o))
                    c.includes(i) &&
                        Qe(n, e, t, d.callable, d.delegationSelector);
            }
            function Yn(n) {
            ...
            const x = {
                ...
                trigger(n, e, t) {
                    ...
                    const j = rn(
                        new Event(e, { bubbles: y, cancelable: !0 }),
                        t
                    );
                    return (
                        M && j.preventDefault(),
                ...
                getDataAttributes(n) {
                    ...
                    const e = {},
                        t = Object.keys(n.dataset).filter(
                            (i) =>
                                i.startsWith("bs") && !i.startsWith("bsConfig")
                        );
                    for (const i of t) {
                        let o = i.replace(/^bs/, "");
            ...
            class et extends he {
                ...
                _addTouchEventListeners() {
                    ...
                    const t = {
                        leftCallback: () =>
                            this._slide(this._directionToOrder(qe)),
                        rightCallback: () =>
            ...
            function at(n, e, t) {
                ...
                e &&
                    ce(n) &&
                    ((o =
                        (n.offsetWidth > 0 && st(i.width) / n.offsetWidth) ||
                        1),
                    (c =
                        (n.offsetHeight > 0 && st(i.height) / n.offsetHeight) ||
                        1));
            ...
            function fi(n) {
                return !ce(n) || Ae(n).position === "fixed"
                    ? null
                    : n.offsetParent;
            }
            function Ko(n) {
                ...
                for (
                    ...
                    if (
                        ...
                        c.perspective !== "none" ||
                        c.contain === "paint" ||
                        ["transform", "perspective"].indexOf(c.willChange) !==
                            -1 ||
            ...
            function jt(n, e) {
                ...
                var i = Ei(n),
                    ...
                    c = se(i),
                    d = o
                        ? [c].concat(c.visualViewport || [], bn(i) ? i : [])
                        : i,
                    y = e.concat(d);
                    ...
                    var j = {
                        ...
                        N = {
                            ...
                            setOptions: function (Y) {
                                var U =
                                    typeof Y == "function" ? Y(j.options) : Y;
                                R(),
                                ...
                                var X = xs(
                                    Es([].concat(i, j.options.modifiers))
                                );
                                return (
                                    (j.orderedModifiers = X.filter(function (
                                        V
                                    ) {
                                        return V.enabled;
                                    })),
            ...
            class fe extends he {
                ...
                _getPlacement() {
                    ...
                    const t =
                        getComputedStyle(this._menu)
                            ...
                            .trim() === "end";
                    return e.classList.contains(Is)
                        ? t
                            ? Ws
                            : Ks
                        : t
                ...
                static clearMenus(e) {
                    if (e.button === Ss || (e.type === "keyup" && e.key !== Ii))
                        return;
                    const t = C.find(Hs);
                    for (const i of t) {
            ...
            class Ki extends gt {
                ...
                deactivate() {
                    this._isActive &&
                        ((this._isActive = !1), x.off(document, Bt));
                }
                _handleFocusin(e) {
                ...
                _handleKeydown(e) {
                    e.key === oa &&
                        (this._lastTabNavDirection = e.shiftKey ? Fi : sa);
                }
            }
            ...
            class we extends he {
                ...
                show(e) {
                    if (
                        this._isShown ||
                        x.trigger(this._element, Na, { relatedTarget: e })
                            .defaultPrevented
                    )
                        return;
                    (this._isShown = !0),
            ...
            function Ka(n, e, t) {
                ...
                for (const d of c) {
                    ...
                    const b = [].concat(...d.attributes),
                        M = [].concat(e["*"] || [], e[y] || []);
                    for (const j of b)
                        Fa(j, M) || d.removeAttribute(j.nodeName);
                }
            ...
            class ke extends he {
                ...
                _createPopper(e) {
                    const t = H(this._config.placement, [
                            this,
                            e,
                            this._element,
                        ]),
            ...
            class Ke extends he {
                ...
                _keydown(e) {
                    ...
                    let i;
                    if ([Dn, ur].includes(e.key))
                        i = t[e.key === Dn ? 0 : t.length - 1];
                    else {
            ...
            class Ot extends he {
                ...
                hide() {
                    if (
                        !this.isShown() ||
                        x.trigger(this._element, Jl).defaultPrevented
                    )
                        return;
                    const t = () => {
                ...
                _setListeners() {
                    x.on(this._element, Ul, (e) => this._onInteraction(e, !0)),
                        x.on(this._element, Xl, (e) =>
                            this._onInteraction(e, !1)
                        ),
                        x.on(this._element, Ql, (e) =>
                            this._onInteraction(e, !0)
                        ),
                        x.on(this._element, Zl, (e) =>
                            this._onInteraction(e, !1)
                        );
                }
                _clearTimeout() {
            ...
            for (let r = 0; r < Q.childElementCount; r++) {
                ...
                if (
                    ...
                    if (a.classList.contains("submenu-open")) {
                        const u = ~~[
                            ...a.querySelectorAll(".submenu-link"),
                        ].reduce((p, h) => p + h.clientHeight, 0);
                        f += u;
                    }
                }
            }
    ...
    class Mr {
        ...
        init() {
            const z = (r) => {
                if (r.classList.contains("submenu-open")) {
                    r.classList.remove("submenu-open");
                    r.classList.add("submenu-closed");
                    sessionStorage.setItem("sub-state", "close");
                } else {
                    r.classList.remove("submenu-closed");
                    r.classList.add("submenu-open");
                    sessionStorage.setItem("sub-state", "open");
                }
            };
            const savedState = sessionStorage.getItem("sub-state");
            if (savedState === "open") {
            ...
            document
                ...
                .forEach((r) =>
                    r.addEventListener("click", this.toggle.bind(this))
                ),
                document
