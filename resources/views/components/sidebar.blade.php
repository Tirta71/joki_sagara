    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li
                    class="sidebar-item has-sub {{ Request::is('locations') || Request::is('locations/*') || Request::is('categories') || Request::is('categories/*') || Request::is('fixed_assets') || Request::is('fixed_assets/*') || Request::is('accumulated_depreciations') || Request::is('accumulated_depreciations/*') || Request::is('depreciations') || Request::is('depreciations/*') ? 'active' : '' }}">
